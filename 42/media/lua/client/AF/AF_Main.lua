...
AF.VERSION = AF.VERSION or "0.15.4"
...
local function isZombieOnFloor(zombie)
    local floor = false
    pcall(function()
        if zombie and zombie.isOnFloor and zombie:isOnFloor() then floor = true end
    end)
    pcall(function()
        if not floor and zombie and zombie.isKnockedDown and zombie:isKnockedDown() then floor = true end
    end)
    pcall(function()
        if not floor and zombie and zombie.isCrawling and zombie:isCrawling() then floor = true end
    end)
    return floor
end
