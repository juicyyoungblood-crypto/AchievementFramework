...
AF.VERSION = AF.VERSION or "0.14.0"
...
function Track.getData(player)
    ...
    for _, k in ipairs({ "total", "combat", "walking", "running", "sprinting", "vehicle", "day", "night" }) do
...
local function sampleDistance(player)
    ...
    buckets[#buckets + 1] = night and "night" or "day"
    ...
    if inVeh then
        ...
        local aiming, sprint, running = false, false, false
