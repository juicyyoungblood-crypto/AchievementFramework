...
local WEAPON_ITEMS = {
    ...
    { id = "base.baseballbatnails", fullType = "Base.BaseballBatNails", label = "Baseball Bat (Nails)" },
...
local DISTANCE_MODS = {
    { id = "combat",          label = "Combat stance (aiming, standing)" },
    { id = "walking",         label = "Walking (on foot, not sneaking)" },
    { id = "running",         label = "Running (on foot, not sneaking)" },
    { id = "sprinting",       label = "Sprinting (on foot, not sneaking)" },
    { id = "sneaking",        label = "Any sneaking (on foot, total)" },
    { id = "sneak_walking",   label = "Sneak walking" },
    { id = "sneak_running",   label = "Sneak running" },
    { id = "sneak_sprinting", label = "Sneak sprinting" },
    { id = "sneak_combat",    label = "Sneak combat stance (aiming while sneaking)" },
...
function C.getModifiersForAction(actionId)
    ...
    if actionId == "distance" then
        return noneFirst(DISTANCE_MODS)
    end
