...
function R.buildTraits()
    ...
    pcall(function()
        ...
        local traits = TraitFactory.getTraits and TraitFactory.getTraits()
        ...
        if traits.size then
            for i = 0, traits:size() - 1 do
                ...
                if t then
                    ...
                    -- positive traits typically cost > 0 in PZ (you spend points to take them)
                    -- free/negative: cost <= 0. Keep cost > 0 only.
                    local id = ""
...
function R.deliver(player, def)
    ...
    if rtype == "trait" then
        ...
        pcall(function()
            ...
            if traits.contains and traits:contains(reward) then
        ...
        print("[AF] deliver trait " .. reward .. " " .. msg)
        return ok, msg
    end
